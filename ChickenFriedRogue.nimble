...
task runr, "Runs ChickenFriedRogue for current platform":
 exec &"nim c -r {releaseOpts} -o:ChickenFriedRogue src/main.nim"

task rund, "Runs debug ChickenFriedRogue for current platform":
 exec &"nim c -r {debugOpts} -o:ChickenFriedRogue src/main.nim"

task release, "Builds ChickenFriedRogue for current platform":
 exec &"nim c {releaseOpts} -o:ChickenFriedRogue src/main.nim"

task webd, "Builds debug ChickenFriedRogue for web":
 exec &"nim c {debugOpts} -d:emscripten -o:ChickenFriedRogue.html src/main.nim"

task webr, "Builds release ChickenFriedRogue for web":
 exec &"nim c {releaseOpts} -d:emscripten -o:ChickenFriedRogue.html src/main.nim"

task debug, "Builds debug ChickenFriedRogue for current platform":
 exec &"nim c {debugOpts} -o:ChickenFriedRogue_debug src/main.nim"
